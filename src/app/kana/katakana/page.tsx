            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-3 rounded-xl bg-purple-600 px-6 py-3.5 font-semibold text-white transition-colors hover:bg-purple-700 active:bg-purple-800"
                >
