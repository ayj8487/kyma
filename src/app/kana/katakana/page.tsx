...
import { katakanaData, kanaRows } from "@/data/kana";
...
const dakuonRows = [
  { id: "ga", label: "ガ행", vowels: ["ga", "gi", "gu", "ge", "go"] },
  { id: "za", label: "ザ행", vowels: ["za", "ji", "zu", "ze", "zo"] },
  { id: "da", label: "ダ행", vowels: ["da", "dji", "dzu", "de", "do"] },
  { id: "ba", label: "バ행", vowels: ["ba", "bi", "bu", "be", "bo"] },
];

const handakuonRows = [
  { id: "pa", label: "パ행", vowels: ["pa", "pi", "pu", "pe", "po"] },
];
...
export default function KatakanaPage() {
  ...
  const filteredData = katakanaData.filter((k) => k.category === activeTab);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50 dark:from-gray-950 dark:to-slate-900">
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            가타카나 문자표 - 문자를 클릭하면 상세 정보를 확인할 수 있습니다
          </p>
        </div>
        ...
        <div className="mb-8 flex gap-2 overflow-x-auto">
          {(Object.entries(categoryLabels) as [CategoryTab, string][]).map(
            ([key, label]) => {
              const hasData = katakanaData.some((k) => k.category === key);
              ...
              {row.vowels.map((romaji, idx) => {
                ...
                return (
                  <button
                    ...
                    className="group flex flex-col items-center justify-center rounded-xl border border-gray-200 bg-white px-2 py-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-purple-300 hover:shadow-lg hover:shadow-purple-100 active:translate-y-0 dark:border-gray-700 dark:bg-gray-800 dark:hover:border-purple-600 dark:hover:shadow-purple-900/20"
                  >
                    <span className="text-2xl font-medium text-gray-900 transition-colors group-hover:text-purple-600 dark:text-white dark:group-hover:text-purple-400 sm:text-3xl">
                      {char.character}
                    </span>
          ...
          >
            ...
            >
              ...
              <div className="mb-6 text-center">
                <div className="mb-4 text-8xl font-bold text-purple-600 dark:text-purple-400">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-xl bg-purple-600 px-6 py-3.5 font-semibold text-white transition-colors hover:bg-purple-700 active:bg-purple-800"
              >
